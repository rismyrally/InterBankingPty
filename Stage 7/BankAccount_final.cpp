...
BankBranch::BankBranch(int bsbNum, string add, int pc)
{
	this->BSBnumber = bsbNum;
	this->address = add;
	this->postcode - pc;
}
...
void BankBranch::displayDetails()
{
	cout << "\nBSB Number: " << this->BSBnumber << endl;
	cout << "Bank Branch Address: " << this->address << endl;
	cout << "Ban Branch Postcode: " << this->postcode << endl;
}
...
public:
	BankAccount();
	BankAccount(int, string, int, int, double = 0.0);
...
BankAccount::BankAccount(int bsb, string addrs, int postc, int acnum, double acbal) : homeBranch(bsb, addrs, postc)
{
...
{
	this->homeBranch.displayDetails();
...
public:
	SavingsAccount(double = 3.0);
	void displayAccount();
};

SavingsAccount::SavingsAccount(double interestRate)
{
	this->savingsInterest = interestRate;
}

void SavingsAccount::displayAccount()
{
	cout << "\nAccount Number: " << this->getAccountNumber << endl;
	cout << "Account Balance: " << this->setAccountBalance << endl;
	cout << "Interest Rate: " << this->savingsInterest << endl;
}
...
CheckingAccount::CheckingAccount(double interestRate)
{
	this->checkingInterest = interestRate;
}
...
void CheckingAccount::displayAccount()
{
	cout << "\nAccount Number: " << this->getAccountNumber << endl;
	cout << "Account Balance: " << this->setAccountBalance << endl;
	cout << "Interest Rate: " << this->checkingInterest << endl;
	cout << "Monthly Fee: " << this->monthlyFee << endl;
	cout << "Number of checks allowed per month: " << this->checksPerMonth << endl;
}
